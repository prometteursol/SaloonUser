...
public class OperatorsListCartServiceAdapter extends RecyclerView.Adapter<OperatorsListCartServiceAdapter.ViewHolder> {

    Activity nActivity;
    private final OnItemClickListener listener;
    int selectedPosition = -1;
    List<CartDetailBean.Operator> operators;
    public OperatorsListCartServiceAdapter(Activity nActivity, List<CartDetailBean.Operator> operators, OnItemClickListener listener) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(nActivity).inflate(R.layout.recycle_operators_list,
                parent, false);
        return new OperatorsListCartServiceAdapter.ViewHolder(view);
    }
